                    ...
                    <div class="bible-side d-none d-lg-block">
                        <div class="bible-side-wrap">
                            <div class="bible-side-tabs-wrap d-flex">
                                <div class="bible-side-tab bible-side-tab-new" onclick="toggleTab(this)">Новый завет
                                </div>
                                <div class="bible-side-tab bible-side-tab-old current" onclick="toggleTab(this)">Ветхий
                                    завет
                                </div>
                            </div>
