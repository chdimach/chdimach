...
<main>
				...
				<div class="current-book-wrapper bible-nav-item d-flex align-items-center" >
					...
					<div class="bible-side d-none">
						<div class="bible-side-wrap">
							...
							<div class="bible-books-new d-none">
								<div class="bible-books-wrap mt-lg-0 mt-2 d-flex justify-content-center flex-column">
                                    <?php
                                    $books = get_books();
                                    $transl='syn';
                                    ?>
                    ...
                    ';
							...
							<div class="bible-books-old">
								<div class="bible-books-wrap bible-books-wrap-old mt-lg-0 mt-2 d-flex justify-content-center flex-column">
                                    <?php foreach ($books as $book):?>
                                        <?php if($book['book_number']<40){
                                            echo '<a href="chapters.php?trans='.$transl.'&number_book='.$book["book_number"].'& name='.$book['name'].'" class="bible-book"><span>'.$book['name'] .'</span></a>';
                                        }?>
	...
	<div class="d-flex justify-content-between container mt-4 p-3 bible-nav-bottom">
		<a class="d-flex align-items-center" href="<?php echo nextback('back');?>">
			...
			<span class="ml-1 d-none d-md-block">Предыдущая глава</span>
		</a>
		<a class="d-flex align-items-center" href="<?php echo nextback('next'); ?>">
			<span class="mr-1 d-none d-md-block">Следущая глава</span>
